...
<p>The project makes use of a genetic algorithm to satisfy the soft and hard constraints and generate the most optimal timetable. The web application includes a simple authentication-authorization, and on successfull authentication the user is redirected the admin dashboard.</p>
